view: ASAdventureSmall {
  ...
  dimension: Order_DateAttr {
    label: "Order DateAttr"
    description: "Date secondary attribute "
    type: number
    sql: ${TABLE}.`Order DateAttr`;;
  }
  ...
  dimension: Order_Day_Of_Quarter {
    label: "Order Day Of Quarter"
    type: string
    sql: ${TABLE}.`Order Day Of Quarter`;;
  }

  dimension: Order_Day_Of_Week {
    label: "Order Day Of Week"
    type: string
    sql: ${TABLE}.`Order Day Of Week`;;
  }

  dimension: Order_Day_Of_Year {
    label: "Order Day Of Year"
    type: string
    sql: ${TABLE}.`Order Day Of Year`;;
  }

  dimension: Order_Half_Year_Of_Year {
    label: "Order Half Year Of Year"
    type: string
    sql: ${TABLE}.`Order Half Year Of Year`;;
  }

  dimension: Order_ISO_8601_Day_Of_Week {
    label: "Order ISO 8601 Day Of Week"
    type: string
    sql: ${TABLE}.`Order ISO 8601 Day Of Week`;;
  }

  dimension: Order_ISO_8601_Day_Of_Year {
    label: "Order ISO 8601 Day Of Year"
    type: string
    sql: ${TABLE}.`Order ISO 8601 Day Of Year`;;
  }

  dimension: Order_ISO_8601_Week_Of_Year {
    label: "Order ISO 8601 Week Of Year"
    type: string
    sql: ${TABLE}.`Order ISO 8601 Week Of Year`;;
  }

  dimension: Order_Month_Of_Half_Year {
    label: "Order Month Of Half Year"
    type: string
    sql: ${TABLE}.`Order Month Of Half Year`;;
  }

  dimension: Order_Month_Of_Quarter {
    label: "Order Month Of Quarter"
    type: string
    sql: ${TABLE}.`Order Month Of Quarter`;;
  }
  ...
  dimension: Order_Quarter_Of_Half_Year {
    label: "Order Quarter Of Half Year"
    type: string
    sql: ${TABLE}.`Order Quarter Of Half Year`;;
  }

  dimension: Order_Quarter_Of_Year {
    label: "Order Quarter Of Year"
    type: string
    sql: ${TABLE}.`Order Quarter Of Year`;;
  }

  dimension: Order_Reporting_Day_Of_Half_Year {
    label: "Order Reporting Day Of Half Year"
    type: string
    sql: ${TABLE}.`Order Reporting Day Of Half Year`;;
  }
  ...
  dimension: Order_Reporting_Day_Of_Quarter {
    label: "Order Reporting Day Of Quarter"
    type: number
    sql: ${TABLE}.`Order Reporting Day Of Quarter`;;
  }
  ...
  dimension: Order_Reporting_Half_Year_Of_Year {
    ...
    type: string
    sql: ${TABLE}.`Order Reporting Half Year Of Year`;;
  }

  dimension: Order_Reporting_Month_Of_Half_Year {
    label: "Order Reporting Month Of Half Year"
    type: string
    sql: ${TABLE}.`Order Reporting Month Of Half Year`;;
  }
  ...
  dimension: Order_Reporting_Week_Of_Half_Year {
    label: "Order Reporting Week Of Half Year"
    type: string
    sql: ${TABLE}.`Order Reporting Week Of Half Year`;;
  }
  ...
  dimension: Order_Reporting_Week_Of_Quarter {
    label: "Order Reporting Week Of Quarter"
    type: string
    sql: ${TABLE}.`Order Reporting Week Of Quarter`;;
  }
  ...
  dimension: ISO8601Week_Order_ISO_8601_Day {
    label: "  Order ISO 8601 Day"
    group_label: "Order ISO8601Week"
    type: string
    sql: ${TABLE}.`Order ISO 8601 Day`;;
  }

  dimension: ISO8601Week_Order_ISO_8601_Week {
    label: "   Order ISO 8601 Week"
    group_label: "Order ISO8601Week"
    type: string
    sql: ${TABLE}.`Order ISO 8601 Week`;;
    drill_fields: [ISO8601Week_Order_ISO_8601_Day]
  }

  dimension: ISO8601Week_Order_ISO_8601_Year {
    label: "    Order ISO 8601 Year"
    group_label: "Order ISO8601Week"
    type: string
    sql: ${TABLE}.`Order ISO 8601 Year`;;
    drill_fields: [ISO8601Week_Order_ISO_8601_Week]
  }

  dimension: Retail445_Order_Reporting_Day {
    label: "  Order Reporting Day"
    group_label: "Order Retail445"
    type: date_time
  ...
  dimension: StandardMonth_Order_Date {
    label: " Order Date"
    group_label: "Order StandardMonth"
    type: number
    sql: ${TABLE}.`Order Date`;;
  }

  dimension: StandardMonth_Order_Half_Year {
    label: "    Order Half Year"
    group_label: "Order StandardMonth"
    type: string
    sql: ${TABLE}.`Order Half Year`;;
    drill_fields: [StandardMonth_Order_Quarter]
  }

  dimension: StandardMonth_Order_Month {
    label: "  Order Month"
    group_label: "Order StandardMonth"
    type: string
    sql: ${TABLE}.`Order Month`;;
    drill_fields: [StandardMonth_Order_Date]
  }

  dimension: StandardMonth_Order_Quarter {
    label: "   Order Quarter"
    group_label: "Order StandardMonth"
    type: string
    sql: ${TABLE}.`Order Quarter`;;
    drill_fields: [StandardMonth_Order_Month]
  }

  dimension: StandardMonth_Order_Year {
    label: "     Order Year"
    group_label: "Order StandardMonth"
    type: string
    sql: ${TABLE}.`Order Year`;;
    drill_fields: [StandardMonth_Order_Half_Year]
  }

  dimension: StandardWeek_Order_Date {
    label: " Order Date"
    group_label: "Order StandardWeek"
    type: number
    sql: ${TABLE}.`Order Date`;;
  }

  dimension: StandardWeek_Order_Week {
    label: "  Order Week"
    group_label: "Order StandardWeek"
    type: string
    sql: ${TABLE}.`Order Week`;;
    drill_fields: [StandardWeek_Order_Date]
  }

  dimension: StandardWeek_Order_Year {
    label: "   Order Year"
    group_label: "Order StandardWeek"
    type: string
    sql: ${TABLE}.`Order Year`;;
    drill_fields: [StandardWeek_Order_Week]
  }
  ...
  measure: Order_Quantity_Long {
    ...
    group_label: "InternetSales"
    description: "Created to match the Long version of Order Quantity in the SSAS Adventure Works Cube."
    value_format: "#,##0"
    type: sum
  ...
  set: ResellerDetails {
    fields: [ResellerName,Business_Type2,Reseller_Sales_Amount_Local]
  }
